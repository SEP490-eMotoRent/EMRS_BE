...
namespace EMRS.Infrastructure.Services
{
    public  class EmailService:IEmailService
    {
        ...
        public async Task SendVerificationOtpAsync(string toEmail, string verificationCode,
           int timeToExpire)
        {
            try
            {
                ...
                var bodyBuilder = new BodyBuilder
                {
                    ...
                    <body style='font-family:Arial, sans-serif;'>
                        <div style='max-width:600px;margin:auto;padding:20px;border-radius:10px;background-color:#f8f9fa;'>
                            ...
                            <p>Dear user,</p>
                         <p>You are signing a contract on EMRS. Please use the verification code below to complete the process:</p>
                        <h1 style='color:#28a745;text-align:center;'>{verificationCode}</h1>
                        <p>This code will expire in <b>{timeToExpire} second</b>. Do not share it with anyone.</p>
